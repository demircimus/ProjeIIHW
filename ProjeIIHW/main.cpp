...
#define RESOURCE_PATH "C:/Users/demircimus/Documents/Visual Studio 2010/Projects/ProjeIIHW/ProjeIIHW/"
					//C:\Users\demircimus\Documents\Visual Studio 2010\Projects\ProjeIIHW\ProjeIIHW
#ifdef _WIN32
...
#define WINDOW_TITLE_PREFIX "Alex De Souza/"
...
void setupScene(){
	...
	SimpleEffect* tempEffect = new SimpleEffect(&CurrentWidth,&CurrentHeight); 
    
    scene->addEffect(tempEffect);
